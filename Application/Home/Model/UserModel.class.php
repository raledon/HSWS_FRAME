...
class UserModel extends Model{
    ...
    protected $fields = array('userId', 'password', 'name', 'gender', 'telephone', 'email', 'avatar', 'slogan', 'birthday', 'createdAt', 'character');
    protected $pk = 'userId';
    protected $updateFields = 'password, name, gender, telephone, email, avatar, slogan, birthday'; // 编辑数据的时候只允许写入email字段
    ...
    protected $_auto = array (
        array('createdAt', 'curDate', 1, 'callback'), // 对regdate字段在新增的时候写入当前时间戳
